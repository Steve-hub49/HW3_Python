...
with open(input_file,newline="", encoding="utf-8") as budget:
    ...
    for i in range(len(total_profit)-1):
        ...
        monthly_profit_change.append(int(total_profit[i+1]-total_profit[i])
 
# Define max functions
def max_increase_value
def max_decrease_value 
def max_increase_month                             
def max_increase_month                                     
...
# Output files
# Output files
output_file = Path(r'C:\Users\steve\homework\PyBank\PyBank_data.csv')

open(r"C:\Users\steve\homework\PyBank\PyBank_data.csv")
# Write methods to print to Financial_Analysis_Summary 

# Write methods to print to Financial_Analysis_Summary
summary_file=open(r'C:\Users\steve\homework\PyBank\PyBank_data.csv',
