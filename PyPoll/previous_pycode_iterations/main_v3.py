...
csv_file_path = Path(r'C:\Users\steve\homework\PyPoll\PyPoll_data.csv')
...
with open(output_file,"w") as file: # Import dependencies

# Assign output file location with the pathlib library
output_file = Path("python-challenge", "PyPoll", "Election_Results_Summary.txt")
